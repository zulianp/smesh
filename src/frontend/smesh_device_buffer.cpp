...
#define SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(T)                  \
...
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(f16);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(f32);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(f32);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(f64);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(f64);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(i32);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(i32);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(i64);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(i64);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(i16);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(i16);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(u8);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(u8);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D(u16);
SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE(u16);

#undef SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D
#undef SMESH_EXPLICIT_INSTANTIATE_DEVICE_BUFFER_2D_DEVICE

...
template int Exchange::gather<f16>(f16 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<f32>(f32 *const inout);
template int Exchange::gather<f32>(f32 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<f64>(f64 *const inout);
template int Exchange::gather<f64>(f64 *const inout, const ptrdiff_t block_size);
...
template int Exchange::gather<i16>(i16 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<i32>(i32 *const inout);
template int Exchange::gather<i32>(i32 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<i64>(i64 *const inout);
template int Exchange::gather<i64>(i64 *const inout, const ptrdiff_t block_size);
...
template int Exchange::gather<u16>(u16 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<u32>(u32 *const inout);
template int Exchange::gather<u32>(u32 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<u64>(u64 *const inout);
template int Exchange::gather<u64>(u64 *const inout, const ptrdiff_t block_size);
template int Exchange::gather<char>(mask_t *const inout);
template int Exchange::gather<char>(mask_t *const inout, const ptrdiff_t block_size);

#if defined(__clang__)
template int Exchange::gather<long>(long *const inout);
template int Exchange::gather<long>(long *const inout, const ptrdiff_t block_size);
#endif

template int Exchange::scatter_add<f16>(f16 *const inout);
template int Exchange::scatter_add<f16>(f16 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<f32>(f32 *const inout);
template int Exchange::scatter_add<f32>(f32 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<f64>(f64 *const inout);
template int Exchange::scatter_add<f64>(f64 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<i8>(i8 *const inout);
template int Exchange::scatter_add<i8>(i8 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<i16>(i16 *const inout);
template int Exchange::scatter_add<i16>(i16 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<i32>(i32 *const inout);
template int Exchange::scatter_add<i32>(i32 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<i64>(i64 *const inout);
template int Exchange::scatter_add<i64>(i64 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<u8>(u8 *const inout);
template int Exchange::scatter_add<u8>(u8 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<u16>(u16 *const inout);
template int Exchange::scatter_add<u16>(u16 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<u32>(u32 *const inout);
template int Exchange::scatter_add<u32>(u32 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<u64>(u64 *const inout);
template int Exchange::scatter_add<u64>(u64 *const inout, const ptrdiff_t block_size);
template int Exchange::scatter_add<char>(mask_t *const inout);
template int Exchange::scatter_add<char>(mask_t *const inout, const ptrdiff_t block_size);


#if defined(__clang__)
template int Exchange::scatter_add<long>(long *const inout);
template int Exchange::scatter_add<long>(long *const inout, const ptrdiff_t block_size);
#endif

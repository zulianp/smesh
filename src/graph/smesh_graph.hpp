...
namespace smesh {
    ...
    int sort_n2e(const ptrdiff_t nnodes, const count_t *const SMESH_RESTRICT n2eptr, element_idx_t *const SMESH_RESTRICT elindex);
     ...
     */
    template <typename idx_t, typename count_t>
    int crs_to_coo(const ptrdiff_t n, const count_t *const rowptr, idx_t *const SMESH_RESTRICT row_idx);
    ...
    idx_t find_idx(const idx_t key, const idx_t *const SMESH_RESTRICT arr, idx_t size);

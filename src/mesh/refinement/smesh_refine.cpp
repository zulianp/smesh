...
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i64, i32, f32);
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i64, i64, f32);
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i32, i32, f64);
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i64, i32, f64);
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i64, i64, f64);
} // namespace smesh

...
#define SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(IDX_T, COUNT_T, ELEMENT_IDX_T,   \
                                              GEOM_T)                          \
  template int mesh_refine<IDX_T, COUNT_T, ELEMENT_IDX_T, GEOM_T>(             \
...
namespace smesh {
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i32, i32, i32, f32);
SMESH_EXPLICIT_INSTANTIATE_REFINEMENT(i64, i64, i64, f32);
} // namespace smesh

...
namespace smesh {
    ...
    int tet4_adjugate_fill_simd(const ptrdiff_t                                          nelements,
...
#pragma omp simd
    ...
    int tet4_adjugate_fill(const ptrdiff_t                                          nelements,
                           ...
                           DeterminantType *const SMESH_RESTRICT                    determinant) {
        if (stride == 1) {
            return tet4_adjugate_fill_simd(nelements, elements, points, adjugate, determinant);
        }
...
#pragma omp for schedule(static)
    ...
    // HEX8
    template <typename AdjugateType, typename DeterminantType>
    int hex8_adjugate_fill_simd(const ptrdiff_t                                          nelements,
                                const idx_t *const SMESH_RESTRICT *const SMESH_RESTRICT  elements,
                                const geom_t *const SMESH_RESTRICT *const SMESH_RESTRICT points,
                                const geom_t                                             qx,
                                const geom_t                                             qy,
...
#pragma omp simd
    ...
    template <typename AdjugateType, typename DeterminantType>
    int hex8_adjugate_fill(const ptrdiff_t                                          nelements,
                           const idx_t *const SMESH_RESTRICT *const SMESH_RESTRICT  elements,
                           const geom_t *const SMESH_RESTRICT *const SMESH_RESTRICT points,
                           const geom_t                                             qx,
                           const geom_t                                             qy,
                           ...
                           DeterminantType *const SMESH_RESTRICT                    determinant) {
        if (stride == 1) {
            return hex8_adjugate_fill_simd(nelements, elements, points, qx, qy, qz, adjugate, determinant);
        }
...
#pragma omp for schedule(static)
    ...
    template <typename AdjugateType, typename DeterminantType>
    int sshex8_macro_adjugate_fill(const int                                                level,
        ...
        const idx_t *const SMESH_RESTRICT macro_elements[8] = {elements[corners[0]],
                                                               elements[corners[1]],
                                                               elements[corners[2]],
                                                               elements[corners[3]],
                                                               elements[corners[4]],
        ...
        return hex8_adjugate_fill(
                nelements, macro_elements, points, (geom_t)0.5, (geom_t)0.5, (geom_t)0.5, stride, adjugate, determinant);
    }

...
#define SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(IDX_T, GEOM_T)                   \
  ...
  template int sshex8_fill_points_1D_map<IDX_T, GEOM_T>(                         \
      const int, const ptrdiff_t,                                               \
      IDX_T *const SMESH_RESTRICT *const SMESH_RESTRICT,                        \
      GEOM_T *const SMESH_RESTRICT *const SMESH_RESTRICT,                       \
...
namespace smesh {
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i16, f32);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i32, f32);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i64, f32);
} // namespace smesh

...
#define SMESH_EXPLICIT_INSTANTIATE_SSHEX8_TO_STANDARD_HEX8_MESH(IDX_T)         \
...
namespace smesh {
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_TO_STANDARD_HEX8_MESH(i16);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_TO_STANDARD_HEX8_MESH(i32);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_TO_STANDARD_HEX8_MESH(i64);
...
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i16, f64, real_t);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i32, f64, real_t);
SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH(i64, f64, real_t);
} // namespace smesh

#undef SMESH_EXPLICIT_INSTANTIATE_SSHEX8_MESH
#undef SMESH_EXPLICIT_INSTANTIATE_SSHEX8_TO_STANDARD_HEX8_MESH

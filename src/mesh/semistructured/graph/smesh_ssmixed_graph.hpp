...
/// Mesh-wide unique SS numbering for HEX8+TET4+WEDGE6+PYRAMID5.
/// Shared edge and shared tri/quad face interiors get the same ids.
/// Volumes stay family-local. HEX+TET-only callers must keep using
/// ssmixed_hex_tet_generate_elements_blocks (bit-identical).
template <typename idx_t>

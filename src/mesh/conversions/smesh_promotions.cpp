...
#define SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15(IDX_T, COUNT_T, ELEM_IDX_T)   \
...
#define SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(IDX_T, COUNT_T, GEOM_T)          \
...
SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15(i16, i32, i32);
SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15(i32, i32, i32);
SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15(i64, i32, i32);
SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15(i64, i64, i64);

SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i16, i32, f32);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i32, i32, f32);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i64, i32, f32);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i64, i64, f32);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i16, i32, f64);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i32, i32, f64);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i64, i32, f64);
SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS(i64, i64, f64);

SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i16, f32);
SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i32, f32);
SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i64, f32);
SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i16, f64);
SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i32, f64);
SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS(i64, f64);
} // namespace smesh

#undef SMESH_EXPLICIT_INSTANTIATE_EXTRUSIONS
#undef SMESH_EXPLICIT_INSTANTIATE_PROMOTIONS
#undef SMESH_EXPLICIT_INSTANTIATE_TET4_TO_TET15

...
#define SMESH_EXPLICIT_INSTANTIATE_TET4_CUBE_CREATE_DISTRIBUTED(IDX_T, GEOM_T)  \
  template int tet4_cube_create_distributed<IDX_T, GEOM_T>(                    \
      MPI_Comm comm, const ptrdiff_t nx, const ptrdiff_t ny,                   \
      const ptrdiff_t nz, const GEOM_T xmin, const GEOM_T ymin,                \
      const GEOM_T zmin, const GEOM_T xmax, const GEOM_T ymax,                 \
      const GEOM_T zmax, int *nnodesxelem_out,                                 \
...
#define SMESH_EXPLICIT_INSTANTIATE_QUAD4_SQUARE_CREATE_DISTRIBUTED(IDX_T,      \
                                                                  GEOM_T)      \
  template int quad4_square_create_distributed<IDX_T, GEOM_T>(                 \
      MPI_Comm comm, const ptrdiff_t nx, const ptrdiff_t ny,                   \
      const GEOM_T xmin, const GEOM_T ymin, const GEOM_T xmax,                 \
      const GEOM_T ymax, int *nnodesxelem_out,                                 \
      ptrdiff_t *n_local_elements_out, ptrdiff_t *n_global_elements_out,       \
      IDX_T ***elems_out, int *spatial_dim_out,                                \
      ptrdiff_t *n_local_nodes_out, ptrdiff_t *n_global_nodes_out,             \
      GEOM_T ***points_out)

#define SMESH_EXPLICIT_INSTANTIATE_TRI3_SQUARE_CREATE_DISTRIBUTED(IDX_T,       \
                                                                  GEOM_T)      \
  template int tri3_square_create_distributed<IDX_T, GEOM_T>(                  \
      MPI_Comm comm, const ptrdiff_t nx, const ptrdiff_t ny,                   \
      const GEOM_T xmin, const GEOM_T ymin, const GEOM_T xmax,                 \
      const GEOM_T ymax, int *nnodesxelem_out,                                 \
      ptrdiff_t *n_local_elements_out, ptrdiff_t *n_global_elements_out,       \
...
#define SMESH_EXPLICIT_INSTANTIATE_QUAD4_RING_CREATE_DISTRIBUTED(IDX_T,        \
                                                                 GEOM_T)       \
  template int quad4_ring_create_distributed<IDX_T, GEOM_T>(                   \
...
SMESH_EXPLICIT_INSTANTIATE_TET4_CUBE_CREATE_DISTRIBUTED(i32, f32);
SMESH_EXPLICIT_INSTANTIATE_TET4_CUBE_CREATE_DISTRIBUTED(i64, f32);
SMESH_EXPLICIT_INSTANTIATE_QUAD4_SQUARE_CREATE_DISTRIBUTED(i32, f32);
SMESH_EXPLICIT_INSTANTIATE_QUAD4_SQUARE_CREATE_DISTRIBUTED(i64, f32);
SMESH_EXPLICIT_INSTANTIATE_TRI3_SQUARE_CREATE_DISTRIBUTED(i32, f32);
...
SMESH_EXPLICIT_INSTANTIATE_TET4_CUBE_CREATE_DISTRIBUTED(i64, f64);
SMESH_EXPLICIT_INSTANTIATE_QUAD4_SQUARE_CREATE_DISTRIBUTED(i32, f64);
SMESH_EXPLICIT_INSTANTIATE_QUAD4_SQUARE_CREATE_DISTRIBUTED(i64, f64);
SMESH_EXPLICIT_INSTANTIATE_TRI3_SQUARE_CREATE_DISTRIBUTED(i32, f64);
...
#undef SMESH_EXPLICIT_INSTANTIATE_TET4_CUBE_CREATE_DISTRIBUTED
